...
export default function CtaBand() {
  ...
  return (
    <section id="contato" style={{ padding: '5rem 2rem', background: 'rgba(56,189,248,0.04)', borderTop: '1px solid rgba(56,189,248,0.1)', borderBottom: '1px solid rgba(56,189,248,0.1)', position: 'relative', zIndex: 2 }}>
      <div style={{ maxWidth: 1200, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '2rem' }}>
        <motion.div ref={ref} initial={{ opacity: 0, x: -30 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.6 }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.75rem', marginBottom: '0.75rem' }}>
            ...
            <span style={{ fontFamily: 'Oswald, sans-serif', fontSize: '0.8rem', fontWeight: 600, letterSpacing: '0.2em', textTransform: 'uppercase', color: '#38BDF8' }}>Pronto para começar</span>
          </div>
          <h2 style={{ fontFamily: '"Barlow Condensed", sans-serif', fontSize: 'clamp(1.8rem,3.5vw,2.6rem)', fontWeight: 800, textTransform: 'uppercase', lineHeight: 1.05 }}>
            Junte-se a <span style={{ color: '#38BDF8' }}>26 Mil</span> membros<br />
        ...
        <motion.div initial={{ opacity: 0, x: 30 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.6, delay: 0.1 }} style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
          <a href="https://discord.com/invite/DWj3QtgMbA" target="_blank" rel="noopener" className="clip-skew"
            style={{ display: 'inline-flex', alignItems: 'center', gap: '0.75rem', fontFamily: 'Oswald, sans-serif', fontSize: '0.9rem', fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase', padding: '0.9rem 2rem', background: '#38BDF8', color: '#05101E', textDecoration: 'none', transition: 'all 0.25s' }}
