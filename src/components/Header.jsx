  ...
  return (
    <header
      style={{
        ...
        background: scrolled ? 'rgba(5,16,30,0.92)' : 'transparent',
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', maxWidth: 1200, margin: '0 auto', padding: '1.2rem 2rem' }}>
        ...
        <a href="#" style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', textDecoration: 'none', marginLeft: '-1rem' }}>
          ...
          <span style={{ fontFamily: '"Barlow Condensed", sans-serif', fontSize: '1.5rem', fontWeight: 800, letterSpacing: '0.05em', textTransform: 'uppercase', color: '#F0EDE8' }}>
            FISH <span style={{ color: '#38BDF8' }}>E-SPORTS</span>
          </span>
        </a>
        ...
        <a
          ...
          onMouseEnter={e => { e.target.style.background = '#38BDF8'; e.target.style.color = '#05101E' }}
      ...
      <AnimatePresence>
        {menuOpen && (
          <motion.div
            ...
            style={{ background: 'rgba(5,16,30,0.97)', borderTop: '1px solid rgba(56,189,248,0.1)', overflow: 'hidden' }}
          >
            <div style={{ display: 'flex', flexDirection: 'column', padding: '1rem 2rem', gap: 0 }}>
              ...
              <a href="#comunidade" onClick={() => setMenuOpen(false)} className="clip-skew"
                style={{ marginTop: '1rem', textAlign: 'center', fontFamily: 'Oswald, sans-serif', fontSize: '0.85rem', fontWeight: 600, letterSpacing: '0.12em', textTransform: 'uppercase', padding: '0.75rem 1.5rem', background: '#38BDF8', color: '#05101E', textDecoration: 'none', display: 'block' }}
