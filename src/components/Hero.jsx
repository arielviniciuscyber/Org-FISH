      ...
      <div style={{ position: "absolute", inset: 0, zIndex: 1 }}>
        <div
          style={{
            ...
            inset: 0,
            background:
              "linear-gradient(135deg,rgba(5,16,30,0.95) 0%,rgba(5,16,30,0.6) 50%,rgba(5,16,30,0.85) 100%)",
          }}
        />
        <div
          style={{
        ...
        <div className="hero-layout">
          ...
          <div className="hero-text">
            ...
            >
              ...
              todos seus amigos para nossa querida org!
            </motion.p>
